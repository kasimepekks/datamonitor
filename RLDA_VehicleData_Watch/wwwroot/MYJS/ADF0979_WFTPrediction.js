layui.use(['element', 'layer', 'laydate', 'table', 'form'], function () {
    ...
    var LFXGDDamage = 6000;
    var RFXGDDamage = 6000;
    var LRXGDDamage = 6000;
    var RRXGDDamage = 6000;
    var LFYGDDamage = 6000;
    var RFYGDDamage = 6000;
    var LRYGDDamage = 6000;
    var RRYGDDamage = 6000;
    var LFZGDDamage = 6000;
    var RFZGDDamage = 6000;
    var LRZGDDamage = 6000;
    var RRZGDDamage = 6000;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (item["chantitle"] == "WFT_Fx_RF") {
                            RFXdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fx_LR") {
                            LRXdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fx_RR") {
                            RRXdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fy_LF") {
                            LFYdamage.push(item["damage"]);

                        }
                        if (item["chantitle"] == "WFT_Fy_RF") {
                            RFYdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fy_LR") {
                            LRYdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fy_RR") {
                            RRYdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fz_LF") {
                            LFZdamage.push(item["damage"]);

                        }
                        if (item["chantitle"] == "WFT_Fz_RF") {
                            RFZdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fz_LR") {
                            LRZdamage.push(item["damage"])
                        }
                        if (item["chantitle"] == "WFT_Fz_RR") {
                    ...
                    for (var i = 0; i < LFXdamage.length; i++) {
                        ...
                        //LFXrealdateanddamagecum.push([datetime[i], LFXdamagecum[i]]);
